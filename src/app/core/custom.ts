...
export class Custom {
  ...
  static readonly  setMarkerColor = (color: string, border: string, radius: string, offset: Offset) => `
  ...
  public static readonly userMarkerIcon : Leaflet.DivIcon = Leaflet.divIcon({
    ...
    html: `<span style="${Custom.setMarkerColor(Custom.userColor,Custom.userMarkerBorderValue, Custom.defaultBorderRadius, Custom.defaultMarkerOffset)}" />`
  });
  ...
  public static readonly serverMarkerIcon : Leaflet.DivIcon = Leaflet.divIcon({
    ...
    // iconSize: [24, 24],
    popupAnchor: Custom.popupAnchor,
    html: `<span style="${Custom.setMarkerColor(Custom.serverColor, Custom.serverMarkerBorderValue, Custom.defaultBorderRadius, Custom.defaultMarkerOffset)}" />`
  });
  ...
  public static readonly fetchedMarkerIcon : Leaflet.DivIcon = Leaflet.divIcon({
    ...
    // iconSize: [42, 42],
    popupAnchor: Custom.popupAnchor,
    html: `<span style="${Custom.setMarkerColor(Custom.fetchedColor, Custom.fetchedMarkerBorderValue, Custom.defaultBorderRadius, Custom.fetchedMarkerOffset)}" />`
  });
  ...
  public static readonly positionMarkerIcon : Leaflet.DivIcon = Leaflet.divIcon({
    ...
    // iconSize: [42, 42],
    popupAnchor: Custom.popupAnchor,
    html: `<span style="${Custom.setMarkerColor(Custom.positionColor, Custom.positionMarkerBorderValue, Custom.userPositionBorderRadius, Custom.defaultMarkerOffset)}" />`
  });
